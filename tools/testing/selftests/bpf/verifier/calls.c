...
{
	"calls: may_consume_ctx kfunc call: access ok in == 0 branch",
	.insns = {
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_MOV64_IMM(BPF_REG_2, (-1L)),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
	BPF_JMP_IMM(BPF_JNE, BPF_REG_0, 0, 1),
	BPF_LDX_MEM(BPF_W, BPF_REG_1, BPF_REG_6, 0),
	BPF_LDX_MEM(BPF_W, BPF_REG_1, BPF_REG_6, 4),
	BPF_MOV64_IMM(BPF_REG_0, 0),
	BPF_EXIT_INSN(),
	},
	.prog_type = BPF_PROG_TYPE_SCHED_CLS,
	...
	.result  = REJECT,
	.errstr = "invalid bpf_context access off=4 size=4",
},
{
	"calls: may_consume_ctx kfunc call: access denied without retval check",
	.insns = {
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_MOV64_IMM(BPF_REG_2, (-1L)),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
...
{
	"calls: may_consume_ctx kfunc call: no nested calls",
	.insns = {
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_MOV64_IMM(BPF_REG_2, (-1L)),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
	...
	.result  = REJECT,
	.errstr = "nested call to maybe consumable kfunc",
},
{
	"calls: basic sanity",
	.insns = {
